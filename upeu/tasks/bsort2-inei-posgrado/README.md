...
> - **Curación del tesauro pendiente (reconciliación 2026-07-16):** [`curacion-tesauro-inei-2026-07-16.md`](curacion-tesauro-inei-2026-07-16.md) — 8 merges de duplicados, 1 backfill (Medicina), **3 conflictos de valor LT↔tesauro** (P35 Teología ⚠️ afecta CIA, P05, P99), 3 huecos reales sin P-code. Oracle NO tiene INEI (`CODIGO_NACIONAL` NULL) → conflictos y huecos requieren el clasificador INEI 2022 oficial externo.
